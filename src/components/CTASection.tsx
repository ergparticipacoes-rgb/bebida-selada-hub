...
export default function CTASection() {
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 sm:px-10 space-y-14">
        <motion.div
          initial={{ opacity: 0, y: 24 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.6, delay: 0.1 }}
          className="rounded-[32px] border border-[#D9B98E]/60 bg-white/6 px-10 md:px-16 py-16 text-center shadow-[0_28px_80px_-30px_rgba(217,185,142,0.55)] backdrop-blur-md space-y-10"
        >
