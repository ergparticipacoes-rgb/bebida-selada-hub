...
export default function HeroSection() {
  return (
    <section className="relative min-h-[85vh] md:min-h-screen overflow-hidden bg-gradient-to-b from-[#001326] via-[#001F33] to-[#012A46] text-white flex flex-col justify-center items-center text-center px-5 sm:px-6 md:px-10 pt-28 pb-12 md:pt-36 md:pb-28">
      ...
      <div className="relative z-10 max-w-5xl mx-auto flex flex-col items-center space-y-4 md:space-y-10">
        <h1 className="text-[2rem] sm:text-[2.2rem] md:text-[3.5rem] font-playfair font-bold tracking-tight text-[#FDF4E1] leading-tight md:leading-[1.2] text-balance drop-shadow-[0_8px_24px_rgba(0,0,0,0.4),0_0_40px_rgba(217,185,142,0.15)]">
        ...
        <p className="hidden md:block text-[1.4rem] max-w-3xl font-semibold text-[#FDF7EB] leading-[1.58] tracking-[0.01em] text-balance drop-shadow-[0_4px_16px_rgba(0,0,0,0.25)]">
        ...
        <p className="md:hidden text-base max-w-3xl font-semibold text-[#FDF7EB] leading-[1.5] tracking-[0.01em] text-balance drop-shadow-[0_2px_8px_rgba(0,0,0,0.2)]">
          É o primeiro sistema brasileiro de certificação inteligente, garantindo autenticidade e confiança no setor de bebidas.
        </p>

        <p className="text-base md:text-xl max-w-3xl text-[#F8F9FB]/85 leading-[1.5] md:leading-[1.7] font-medium text-balance drop-shadow-[0_2px_8px_rgba(0,0,0,0.15)]">
